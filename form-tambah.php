 <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
		...
		<!-- untuk memasukan inputan baru dan menyimpan ke page proses simpan lalu selanjutnya ke database -->
          <form class="form-horizontal" method="POST" action="proses-simpan.php">
            <div class="form-group">
              <label class="col-sm-2 control-label">NIK</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" name="nik" maxlength="5" autocomplete="off" required>
              </div>
            </div>
        ...
        </div> <!-- /.panel-body --> <!-- pegingat agar memudahkan pemanggilan untuk css -->
      </div> <!-- /.panel --> 
    </div> <!-- /.col -->
  </div> <!-- /.row -->