 <div class="row">
    <div class="col-md-12">
	  ...
	  <!-- untuk menampilkan data yang ingin diubah dan yang sudah ada didalam database -->
      <?php
      if (isset($_GET['id'])) {
        $nik   = $_GET['id'];
        $query = mysqli_query($db, "SELECT * FROM data_karyawan WHERE nik='$nik'") or die('Query Error : '.mysqli_error($db));
